...
public class Dealer {
	...
	boolean playerStay(String proceed, Scanner scan) { // Metoden för att loopa spelet tills man vinner, väljer att
														// stanna eller förlorar
	...
	boolean dealerWon() {
		...
		if (playerSum == 21) {
			...
			if (playerSum > dealerSum && playerSum <= 21 || dealerSum > 21) { // Spelaren vinner om playerSum är över
																				// dealerSum eller dealer får över 21
				System.out.println("\nYou win");
				return false;
			} else {
				System.out.println("\nDealer win");
